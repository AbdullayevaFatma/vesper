...
export default function ReservationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(`✓ Reservation confirmed! Table ${data.reservation.tableNumber} is reserved for you on ${formData.date} at ${formData.time}.`);
        setFormData({
          name: '',
          email: '',
          phone: '',
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-10 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-gray-800 placeholder-gray-400"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-gray-800"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-gray-800 appearance-none cursor-pointer"
                >
                  {[1, 2, 3, 4, 5, 6].map(num => (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700 mt-1">
                        {availability.remainingReservations} of {availability.totalTables} tables remaining for {formData.date}
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700 mt-1">
                        Sorry, all tables are reserved for {formData.date}. Please choose another date.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all text-gray-800 placeholder-gray-400 resize-none"
