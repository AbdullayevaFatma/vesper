      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="pt-6">
          <Link href="/reservation">
            <button className="inline-flex items-center gap-2 border border-neutral-800 px-8 py-3 text-sm uppercase tracking-wider bg-neutral-800 text-white transition cursor-pointer">
              RESERVE
