          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="text-white space-y-4">
              ...
              <p className="leading-relaxed text-white/90 max-w-lg">
                Immerse yourself in the art of mixology, where handcrafted
                cocktails and seasonal ingredients come together to create
                unforgettable moments in a luxurious, intimate setting.
              </p>
            </div>
